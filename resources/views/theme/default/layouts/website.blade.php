...
<html lang="{{ get_option('language') == "Arabic" ? "ar" : "en" }}" @if(_lang('SYSDIRECTIONDIR') == 'rtl' || get_option('backend_direction') == 'rtl') direction="rtl" dir="rtl" style="direction: rtl" @endif >
    <head>
        ...
        <link href="{{ asset('theme/default/assets/css/stack-interface.css') }}" rel="stylesheet" type="text/css" media="all" />
        ...
        <link href="{{ asset('theme/default/assets/css/theme-rtl.css') }}" rel="stylesheet" type="text/css" media="all" />
        @else 
        <link href="{{ asset('theme/default/assets/css/theme.css') }}" rel="stylesheet" type="text/css" media="all" />
        @endif
        <link href="{{ asset('theme/default/assets/css/custom.css') }}" rel="stylesheet" type="text/css" media="all" />
        <link href="{{ asset('theme/default/assets/css/font-rubiklato.css') }}" rel="stylesheet" type="text/css" media="all" />
            ...
            <section class="cover unpad--bottom switchable switchable--switch bg--light text-center-xs">
                <div class="container">
                    <div class="row align-items-center justify-content-around">
                        ...
                        <div class="col-md-6">
                            <img alt="Image" src="{{ get_array_option('home_banner_image') != '' ? asset('uploads/media/'.get_array_option('home_banner_image')) : theme_asset('assets/img/avatar-large-3.png') }}" />
                        </div>
                    </div>
                    <!--end of row-->
                </div>

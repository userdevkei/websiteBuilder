                            ...
                            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                    <div class="kt-header__topbar-user">
                                		...
                                		@else
											<img class="kt-badge kt-badge--username kt-badge--unified-brand kt-badge--lg kt-badge--rounded kt-font-light kt-badge--bold" src="{{asset('images/avatar.png')}}" alt="image">
                                        @endif
...
<head>
    ...
    @php
        ...
        $adminAssetBase = app()->environment('local') ? 'backend/assets/admin' : 'public/backend/assets/admin';
    @endphp
    ...
    <!--begin::Global Theme Styles(used by all pages) -->
    <link href="{{ asset($adminAssetBase . '/vendors/global/vendors.bundle.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('backend/plugins/dropify/css/dropify.min.css') }}" rel="stylesheet">
    <link href="{{ asset('backend/plugins/sweet-alert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css">

    @if (_lang('SYSDIRECTIONDIR') == 'rtl' || get_option('backend_direction') == 'rtl')
        <link href="{{ asset($adminAssetBase . '/css/demo1/style.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/vendors/custom/notifications/css/ns-default.rtl.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/vendors/custom/notifications/css/ns-style-other.rtl.css') }}" rel="stylesheet" type="text/css" />
        <link href="//fonts.googleapis.com/css?family=Cairo:300,400,600,700" rel="stylesheet">

        <!--begin::Layout Skins(used by all pages) -->
        <link href="{{ asset($adminAssetBase . '/css/demo1/skins/header/base/light.rtl.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/css/demo1/skins/header/menu/light.rtl.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/css/demo1/skins/brand/light.rtl.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/css/demo1/skins/aside/light.rtl.css') }}" rel="stylesheet" type="text/css" />
        <!--end::Layout Skins -->
    @else
        <link href="{{ asset($adminAssetBase . '/css/demo1/style.bundle.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/vendors/custom/notifications/css/ns-default.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/vendors/custom/notifications/css/ns-style-other.css') }}" rel="stylesheet" type="text/css" />

        <!--begin::Layout Skins(used by all pages) -->
        <link href="{{ asset($adminAssetBase . '/css/demo1/skins/header/base/light.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/css/demo1/skins/header/menu/light.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/css/demo1/skins/brand/light.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset($adminAssetBase . '/css/demo1/skins/aside/light.css') }}" rel="stylesheet" type="text/css" />
        <!--end::Layout Skins -->
    @endif
    <!--end::Global Theme Styles -->
                ...
                <div class="kt-header__topbar">
                    ...
                    @if(get_option('website_language_dropdown','yes') == 'yes')
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                        <span class="kt-header__topbar-icon kt-header__topbar-icon--info">
                                            <img class="" src="{{ asset('uploads/flags/' . (session('language') == '' ? (Auth::user()->language == '' ? get_option('language') : Auth::user()->language) : session('language')) . '.png') }}" alt="" />
                                        </span>
                            </div>
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim">
                                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                    @foreach(get_language_list() as $language)
                                        <li class="kt-nav__item">
                                            <a href="{{url('?language=')}}{{ $language }}" class="kt-nav__link">
                                                <span class="kt-nav__link-icon"><img src="{{ asset('uploads/flags/' . $language . '.png') }}" alt="" /></span>
                                                <span class="kt-nav__link-text">{{ $language }}</span>
                                            </a>
                                        </li>
                                    @endforeach
...
<!--begin::Global Theme Bundle(used by all pages) -->
<script src="{{ asset($adminAssetBase . '/vendors/custom/notifications/js/modernizr.custom.js') }}" type="text/javascript"></script>
<script src="{{ asset($adminAssetBase . '/vendors/custom/notifications/js/classie.js') }}" type="text/javascript"></script>
<script src="{{ asset($adminAssetBase . '/vendors/custom/notifications/js/notificationFx.js') }}" type="text/javascript"></script>
<script src="{{ asset($adminAssetBase . '/vendors/global/vendors.bundle.js') }}" type="text/javascript"></script>
<script src="{{ asset($adminAssetBase . '/js/demo1/scripts.bundle.js') }}" type="text/javascript"></script>
<!--end::Global Theme Bundle -->

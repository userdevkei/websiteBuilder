				...
				<div class="col-12">
					<form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{ url('administration/general_settings/update') }}" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Open AI (Chat Gpt)') }}</label>
{{--                                    <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank" class="btn-link pull-right">{{ _lang('GET API KEY') }}</a>--}}
                                    <input type="text" class="form-control" name="open_ai_key" value="{{ get_option('open_ai_key') }}">
                                </div>
							</div>

							<div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Unsplash API Access key') }}</label>
{{--                                    <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank" class="btn-link pull-right">{{ _lang('GET API KEY') }}</a>--}}
                                    <input type="text" class="form-control" name="unsplash_api_key" value="{{ get_option('unsplash_api_key') }}">
                                </div>
							</div>

							<div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Unsplash API Secret key') }}</label>
{{--                                    <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank" class="btn-link pull-right">{{ _lang('GET API KEY') }}</a>--}}
                                    <input type="text" class="form-control" name="unsplash_secret_key" value="{{ get_option('unsplash_secret_key') }}">
                                </div>
							</div>
			...
			<div class="kt-portlet__body kt-portlet__body--fit-x">
				<div class="col-12">
					<form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{ url('administration/general_settings/update') }}" enctype="multipart/form-data">
                        ...
                        <h5 class="header-title">{{ _lang('Flutterwave') }}</h5>
                        <div class="params-panel border border-dark p-3">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">{{ _lang('Flutterwave Active') }}</label>
                                        <select class="form-control" name="flutter_active" required>
                                            <option value="No" {{ get_option('flutter_active') == 'No' ? 'selected' : '' }}>{{ _lang('No') }}</option>
                                            <option value="Yes" {{ get_option('flutter_active') == 'Yes' ? 'selected' : '' }}>{{ _lang('Yes') }}</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">{{ _lang('Flutterwave Public Key') }}</label>
                                        <input type="text" class="form-control" name="FLUTTER_WAVE_PUBLIC_KEY" value="{{ get_option('FLUTTER_WAVE_PUBLIC_KEY') }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">{{ _lang('Flutterwave Secret Key') }}</label>
                                        <input type="text" class="form-control" name="FLUTTER_WAVE_SECRET_KEY" value="{{ get_option('FLUTTER_WAVE_SECRET_KEY') }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">{{ _lang('Flutterwave Encryption Key') }}</label>
                                        <input type="text" class="form-control" name="FLUTTER_WAVE_ENCRYPTION_KEY" value="{{ get_option('FLUTTER_WAVE_ENCRYPTION_KEY') }}">
                                    </div>
                                </div>

                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label">{{ _lang('Flutterwave Currency') }}</label>
                                        <select class="form-control select2 auto-select" data-selected="{{ get_option('flutter_currency','USD') }}" name="flutter_currency" id="flutter_currency" required>
